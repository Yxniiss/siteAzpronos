document.addEventListener('DOMContentLoaded', () => {
    ...
    (function initAzzPromo(){
        ...
        const copyBtn = promo.querySelector('.azzpromo-copy');
        if (copyBtn) copyBtn.addEventListener('click', (e) => {
            navigator.clipboard.writeText(CONFIG.bonusCode || 'AZZPRONOS').then(() => {
                ...
                // fallback
                alert('Copie : AZZPRONOS');
            });
        });

        // ensure clicking CTA removes promo optionally
        const cta = promo.querySelector('.azzpromo-cta');
